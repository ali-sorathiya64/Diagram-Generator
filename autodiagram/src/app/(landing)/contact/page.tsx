        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <Link href="aasorathiya33@gmail.com">
                  <h3 className="font-semibold">Email</h3>
                  <p className="text-muted-foreground">aasorathiya33@gmail.com</p>
                </Link>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div>
                <Link href="#">
                  ...
                  <p className="text-muted-foreground">@aliSorathiya</p>
                </Link>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div>
                  ...
                  <p className="text-muted-foreground">@ali</p>
              </div>
            </div>
          </div>
        </div>
