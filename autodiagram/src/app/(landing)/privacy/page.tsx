  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="prose max-w-none">
        ...
        <p className="text-gray-600">Last updated February 08, 2025</p>
        ...
        <h2 className="mt-8">1. WHAT INFORMATION DO WE COLLECT?</h2>
        <h3 className="mt-6">Personal information you disclose to us</h3>
        <p><em>In Short: We collect personal information that you provide to us.</em></p>

        <p className="mt-4">We collect personal information that you voluntarily provide to us when you register on the Services, express an interest in obtaining information about us or our products and Services, when you participate in activities on the Services, or otherwise when you contact us.</p>
        ...
        <p className="mt-4"><strong>Payment Data.</strong> We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by Lemon Squeezy. You may find their privacy notice link(s) here: <a href="https://www.lemonsqueezy.com/privacy" target="_blank" rel="noopener noreferrer">https://www.lemonsqueezy.com/privacy</a>.</p>
        ...
        <h3 className="mt-6">Information automatically collected</h3>
        ...
        <p className="mt-4">We automatically collect certain information when you visit, use, or navigate the Services. This information does not reveal your specific identity (like your name or contact information) but may include device and usage information, such as your IP address, browser and device characteristics, operating system, language preferences, referring URLs, device name, country, location, information about how and when you use our Services, and other technical information. This information is primarily needed to maintain the security and operation of our Services, and for our internal analytics and reporting purposes.</p>
        ...
        <h2 className="mt-8">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
        ...
        <p className="mt-4">We process your personal information for a variety of reasons, depending on how you interact with our Services, including:</p>
        <ul className="list-disc list-inside mt-2">
        ...
        <h2 className="mt-8">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
        ...
        <h2 className="mt-8">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
        ...
        <p className="mt-4">We may need to share your personal information in the following situations:</p>
        <ul className="list-disc list-inside mt-2">
          <li><strong>Business Transfers.</strong> We may share or transfer your information in connection with, or during negotiations of, any merger, sale of company assets, financing, or acquisition of all or a portion of our business to another company.</li>
        </ul>

        <h2 className="mt-8">5. DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?</h2>
        ...
        <p className="mt-4">As part of our Services, we offer products, features, or tools powered by artificial intelligence, machine learning, or similar technologies (collectively, &quot;AI Products&quot;). These tools are designed to enhance your experience and provide you with innovative solutions. The terms in this Privacy Notice govern your use of the AI Products within our Services.</p>

        <h3 className="mt-6">Our AI Products</h3>
        <p className="mt-4">Our AI Products are designed for the following functions:</p>
        <ul className="list-disc list-inside mt-2">
          <li>AI applications</li>
        </ul>

        <h3 className="mt-6">How We Process Your Data Using AI</h3>
        <p className="mt-4">All personal information processed using our AI Products is handled in line with our Privacy Notice and our agreement with third parties. This ensures high security and safeguards your personal information throughout the process, giving you peace of mind about your data&apos;s safety.</p>

        <h2 className="mt-8">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
        ...
        <h2 className="mt-8">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
        ...
        <p className="mt-4">We will only keep your personal information for as long as it is necessary for the purposes set out in this Privacy Notice, unless a longer retention period is required or permitted by law (such as tax, accounting, or other legal requirements). No purpose in this Notice will require us to retain your personal information for longer than 30 days after your last interaction with us.</p>

        <h2 className="mt-8">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
        <p><em>In Short: We have implemented measures designed to secure your personal information from accidental loss and from unauthorized access, use, alteration, and disclosure.</em></p>
        ...
        <h2 className="mt-8">9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
        <p><em>In Short: In some regions, such as the European Economic Area (EEA), you have rights that allow you greater control over your personal information. Those rights include the right to request access and erasure of your personal information, among others.</em></p>

        <p className="mt-4">In some regions (like the EEA, UK, and certain other regions), you have certain rights under applicable data protection laws. These may include the right (i) to request access to your personal information, (ii) to request erasure of your personal information, (iii) to restrict the processing of your personal information, or (iv) to object to the processing of your personal information. You can learn more about these rights by visiting <a href="https://www.gov.uk/data-protection" target="_blank" rel="noopener noreferrer">https://www.gov.uk/data-protection</a>.</p>

        <p className="mt-4">If you are located in the EEA or UK and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection authority.</p>

        <h2 className="mt-8">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
        <p><em>In Short: We do not process your personal information for purposes associated with Do Not Track (DNT) signals.</em></p>

        <p className="mt-4">We do not process your personal information for purposes associated with Do Not Track (DNT) signals. However, you can use the DNT feature of your browser to opt out of behavioral advertising from certain third parties.</p>

        <h2 className="mt-8">11. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
        <p><em>In Short: Yes, if you are a resident of the United States, you may have certain rights regarding access to your personal information.</em></p>

        <p className="mt-4">If you are a resident of the United States, you may have certain rights regarding access to your personal information. You can learn more about these rights by visiting <a href="https://www.gov.uk/data-protection" target="_blank" rel="noopener noreferrer">https://www.gov.uk/data-protection</a>.</p>

        <h2 className="mt-8">12. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
        <p><em>In Short: Yes, we will update this Notice as necessary to stay compliant with relevant laws.</em></p>

        <p className="mt-4">We may update this Privacy Notice from time to time. The updated version will be indicated by an updated &quot;Last updated&quot; date and the updated Privacy Notice will be posted on the Services. We encourage you to review this Privacy Notice frequently to be informed of how we are protecting your information.</p>

        <h2 className="mt-8">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
        <p><em>In Short: You can contact us by email.</em></p>

        <p className="mt-4">If you have questions or comments about this Notice, you may contact us at aasorathiya33@gmail.com.</p>

        <h2 className="mt-8">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
        <p><em>In Short: You can review, update, or delete data we collect directly from you, by contacting us.</em></p>

        <p className="mt-4">If you would like to review, update, or delete the personal information that we collect from you, you can contact us at aasorathiya33@gmail.com</p>
      </div>
    </div>
  );
}
