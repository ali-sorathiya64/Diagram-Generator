...
import { Instagram, Loader, RefreshCw, Twitter } from "lucide-react";
                ...
                <div className="flex items-center space-x-2">
                  <TooltipProvider delayDuration={100}>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>Impressive detailed feature:3</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription className="pt-2">
              {session?.user ? (
                "You've used all your credits for today. Since we're still in the experimental stage, you can request more credits by DMing us on instagram."
              ) : (
          ...
          <DialogFooter className="sm:justify-start">
            {session?.user ? (
              <Button
                variant="accent"
                onClick={() => window.open("https://www.instagram.com/ali_sorathiya", "_blank")}
              >
